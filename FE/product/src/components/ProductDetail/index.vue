      ...
      <div class="row">
        ...
        <div class="col-lg-6 col-md-6">
          <div class="product__details__text">
            ...
            <button @click="addToCart(item)" class="primary-btn">ADD TO CART</button>
          ...
          <div class="product__details__tab">
            ...
            <ul class="nav nav-tabs" role="tablist">
              <li class="nav-item" v-for="tab in tabs" :key="tab.name">
                <a :class="['nav-link text-capitalize', active === tab.name ? 'active' : '']" data-toggle="tab" role="tab"
                  @click="active = tab.name" aria-selected="true">{{ tab.name }}</a>
              </li>
            </ul>
...
export default defineComponent({
  ...
  methods: {
    ...
    addToCart(item: any) {
      ...
      const addToCartEvent = new CustomEvent("addToCartCustom");
      document.body.dispatchEvent(addToCartEvent);
    }
  },
});
</script>
